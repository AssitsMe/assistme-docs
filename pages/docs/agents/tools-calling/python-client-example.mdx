...
To enable API calling in your Agent using the Varex Python client, you can use the `client.agent.enable_api_calling` method. This method allows you to activate the API calling feature for a specific agent and define functions for various tasks such as getting a customer's balance, age, or last failed transactions.
